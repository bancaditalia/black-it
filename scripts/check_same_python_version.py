...
try:
    ...
    print(
        f"tomllib found in the stdlib, using that. Since you are running python {platform.python_version()} "
        f"maybe you could get rid of the tomli shim in this file?",
    )
except ImportError:
    ...
    print(
        f"Using tomli as shim for tomllib because you are using python {platform.python_version()}.",
    )
